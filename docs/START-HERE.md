...
**Shipped:** **[v0.7.0](RELEASE-v0.7.0.md)** UX/ops ([roadmap](roadmap-v0.7.0.md)); unsigned portable = current Latest intent until signed.

1. Design: [specs/backend/guardian-design.md](../specs/backend/guardian-design.md) · **profiles:** [guard-profiles-design.md](../specs/backend/guard-profiles-design.md) · **north-star:** [hardware-control-north-star.md](../specs/backend/hardware-control-north-star.md)
2. **Roadmaps:** [next](roadmap-next-release.md) · **[v0.7.0](roadmap-v0.7.0.md)** · [v0.6.0](roadmap-v0.6.0.md) · [future](roadmap-future.md) · [v0.7.0 notes](RELEASE-v0.7.0.md)
